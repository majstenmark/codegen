...
public class procOld implements LabCommSample {
  ...
  public interface Handler extends LabCommHandler {
    public void handle_procOld(procOld value) throws Exception;
  }
  ...
  private static class Dispatcher implements LabCommDispatcher {
    ...
    public void decodeAndHandle(LabCommDecoder d,
      ...
      ((Handler)h).handle_procOld(procOld.decode(d));
    }
    
  }
  
  public static void encode(LabCommEncoder e, procOld value) throws IOException {
    e.begin(procOld.class);
  ...
  public static procOld decode(LabCommDecoder d) throws IOException {
    procOld result;
    result = new procOld();
