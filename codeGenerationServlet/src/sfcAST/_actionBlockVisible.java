...
/**
 * @ast node
 * @declaredat sfc.ast:84
 */
public class _actionBlockVisible extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _actionBlockVisible clone() throws CloneNotSupportedException {
    _actionBlockVisible node = (_actionBlockVisible)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _actionBlockVisible copy() {
      try {
        _actionBlockVisible node = (_actionBlockVisible)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _actionBlockVisible fullCopy() {
    _actionBlockVisible res = (_actionBlockVisible)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1885
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" actionBlockVisible=");
   ...
   */
  public _actionBlockVisible(int i) {
    super(i);
  }
  /**
   * @ast method 
   ...
   */
  public _actionBlockVisible(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _actionBlockVisible(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_actionBlockVisible");
