...
/**
 * @ast node
 * @declaredat sfc.ast:75
 */
public class _value extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _value clone() throws CloneNotSupportedException {
    _value node = (_value)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _value fullCopy() {
    _value res = (_value)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1792
   */
   ...
   */
  public _value(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   * @attribute syn
   * @aspect SFCtoRDF
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:695
   */
  @SuppressWarnings({"unchecked", "cast"})
  public String value() {
   ...
   * @apilevel internal
   */
  private String value_compute() {  return value();  }
  /**
   * @apilevel internal
   */
