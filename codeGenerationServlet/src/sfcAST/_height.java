 ...
 */
public class _height extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _height clone() throws CloneNotSupportedException {
    _height node = (_height)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _height fullCopy() {
    _height res = (_height)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1411
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" height=");
   ...
   */
  public _height(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_height");
