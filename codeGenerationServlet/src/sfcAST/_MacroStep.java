...
/**
 * @ast node
 * @declaredat sfc.ast:58
 */
public class _MacroStep extends ComplexElement implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _MacroStep clone() throws CloneNotSupportedException {
    _MacroStep node = (_MacroStep)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _MacroStep copy() {
      try {
        _MacroStep node = (_MacroStep)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _MacroStep fullCopy() {
    _MacroStep res = (_MacroStep)copy();
  ...
  public void generateXML(PrintStream out,int ind,Value val,RepositoryConnection con) {
		...
		try {
			...
			while (result.hasNext()) {
				...
				String trId = (tr.toString().split("#"))[1];
				TupleQueryResult trResult = queryRepo(con,"{sfc:"+trId+" owl:Individual ?class}");
				while (trResult.hasNext()) {
					BindingSet bindingSet = trResult.next();
					Value rVal = bindingSet.getValue("class");
					System.out.println(rVal);
					String classId = (rVal.toString().split("#"))[1];
					ComplexElement nextTrans = null;
					if (classId.equals("Transition")) {
						link.generateXML(out,ind,tr,con,id);
						nextTrans = new _GCTransition();
					}
					if (classId.equals("ExceptionTransition")) {
						link.generateXML(out,ind,tr,con,id+"E");
						nextTrans = new _ExceptionTransition();
					}
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1599
   */
  public void prettyPrint(String ind, PrintStream pStream) {
    pStream.print(ind+"<MacroStep ");
    ...
    if (getNumElement() == 0) {
       ...
       pStream.println(ind+"</MacroStep> ");
    }
  }
  /**
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:195
   */
  public void populateOntology(RepositoryConnection con, ValueFactory f, URI context) {
		try {
			System.out.println("Adding: MacroStep");
			URI stepURI = f.createURI(baseURI+"#"+id());
			Literal stepName = f.createLiteral(name());
			// con.add(stepURI,OWL.INDIVIDUAL, state);
			con.add(stepURI,OWL.INDIVIDUAL, f.createURI(sfcBaseURI+"#MacroStep"), context);
			con.add(stepURI, f.createURI(baseURI+"#name"), stepName, context);
   ...
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:424
   */
  public void addEnterNode(URI uri, RepositoryConnection con, ValueFactory f, URI context) {
		try {
			con.add(f.createURI(sfcBaseURI+"#"+id()),f.createURI(sfcBaseURI+"#hasEnterStep"),uri,context);
		} catch (OpenRDFException e) {
			// handle exception
			e.printStackTrace(System.out);
		} 
   ...
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:433
   */
  public void addExitNode(URI uri, RepositoryConnection con, ValueFactory f, URI context) {
		try {
			con.add(f.createURI(sfcBaseURI+"#"+id()),f.createURI(sfcBaseURI+"#hasExitStep"),uri,context);
		} catch (OpenRDFException e) {
			// handle exception
			e.printStackTrace(System.out);
		} 
   ...
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:483
   */
   ...
   * @ast method 
   * @aspect NavigateSFC
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:828
   */
   ...
   */
  public _MacroStep(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _MacroStep(List<Attribute> p0, List<Element> p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_MacroStep");
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:750
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getactionText_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:758
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getfileName_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:766
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getheight_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:774
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _id getid() {
    if(getid_computed) {
...
if(true) getid_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:782
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getname_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:790
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getuseIcon_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:798
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getwidth_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:806
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _x getx() {
    if(getx_computed) {
...
if(true) getx_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:814
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _y gety() {
    if(gety_computed) {
...
if(true) gety_computed = true;
   ...
   * @attribute syn
   * @aspect NavigateSFC
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:787
   */
  @SuppressWarnings({"unchecked", "cast"})
