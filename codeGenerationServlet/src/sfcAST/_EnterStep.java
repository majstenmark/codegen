 ...
 */
public class _EnterStep extends ComplexElement implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _EnterStep clone() throws CloneNotSupportedException {
    _EnterStep node = (_EnterStep)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _EnterStep copy() {
      try {
        _EnterStep node = (_EnterStep)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _EnterStep fullCopy() {
    _EnterStep res = (_EnterStep)copy();
   ...
   * @ast method 
   * @aspect GenerateXML
   * @declaredat /Users/maj/Documents/workspace/sfctest/GenerateXML.jrag:189
   */
  public void generateXML(PrintStream out,int ind,Value val,RepositoryConnection con) {
		String id = (val.toString().split("#"))[1];
		out.print(ind(ind)+"<EnterStep id=\""+id+"\" fileName=\"\" height=\"70\"  name=\"\" useIcon=\"0\" width=\"60\" x=\"70\" y=\"25\"");
		TupleQueryResult result = queryRepo(con,"{sfc:"+id+" sfc:actionText ?aText}");
		try {
			while (result.hasNext()) {
				BindingSet bindingSet = result.next();
				String aText = bindingSet.getValue("aText").toString();
				result = queryRepo(con,"{sfc:"+id+" sfc:hasParameter ?param}");
				while (result.hasNext()) {
					BindingSet bSet = result.next();
					Value p = bSet.getValue("param");
					String parId = (p.toString().split("#"))[1];				     
					// System.out.println("{sfc:"+parId+" sfc:hasValue ?val}");
					TupleQueryResult pRes = queryRepo(con,"{sfc:"+parId+" ns:hasValue ?val}");
					while (pRes.hasNext()) {
						BindingSet pSet = pRes.next();
						Value v = pSet.getValue("val");
						aText = setParValue(aText,parId,v.toString());
						System.out.println("Parameter: "+p+" = "+v);
					}
				}
				out.print(" actionText="+aText);
			}
			out.println(">");
			out.println(ind(ind)+"</EnterStep>");		
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1753
   */
  public void prettyPrint(String ind, PrintStream pStream) {
    pStream.print(ind+"<EnterStep ");
    ...
    if (getNumElement() == 0) {
       ...
       pStream.println(ind+"</EnterStep> ");
    }
  }
  /**
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:211
   */
  public void populateOntology(RepositoryConnection con, ValueFactory f, URI context) {
		try {
			...
			con.add(stepURI,OWL.INDIVIDUAL, f.createURI(sfcBaseURI+"#EnterStep"), context);
			con.add(stepURI, f.createURI(baseURI+"#name"), stepName, context);
			enclMacroStep().addEnterNode(stepURI,con,f,context);
   ...
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:473
   */
   ...
   */
  public _EnterStep(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _EnterStep(List<Attribute> p0, List<Element> p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_EnterStep");
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:382
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getactionBlockVisible_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:390
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getactionText_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:398
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getfileName_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:406
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getheight_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:414
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _id getid() {
    if(getid_computed) {
...
if(true) getid_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:422
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getname_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:430
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getuseIcon_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:438
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getwidth_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:446
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _x getx() {
    if(getx_computed) {
...
if(true) getx_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:454
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _y gety() {
    if(gety_computed) {
...
if(true) gety_computed = true;
   ...
   * @attribute syn
   * @aspect NavigateSFC
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:801
   */
  @SuppressWarnings({"unchecked", "cast"})
