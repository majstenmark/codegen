...
/**
 * @ast node
 * @declaredat sfc.ast:69
 */
public class _StringVariable extends ComplexElement implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _StringVariable clone() throws CloneNotSupportedException {
    _StringVariable node = (_StringVariable)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _StringVariable copy() {
      try {
        _StringVariable node = (_StringVariable)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _StringVariable fullCopy() {
    _StringVariable res = (_StringVariable)copy();
   ...
   * @ast method 
   * @aspect GenerateXML
   * @declaredat /Users/maj/Documents/workspace/sfctest/GenerateXML.jrag:277
   */
  public void generateXML(PrintStream out,int ind,Value val,RepositoryConnection con) {
		String id = (val.toString().split("#"))[1];
		// System.out.println("  StringVariable");
		// out.println(ind(ind)+"<StringVar id=\""+id+"\" height=\"14\"  width=\"1063\" x=\"143\" y=\"295\"/>");
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1726
   */
  public void prettyPrint(String ind, PrintStream pStream) {
    pStream.print(ind+"<StringVariable ");
    ...
    if (getNumElement() == 0) {
       ...
       pStream.println(ind+"</StringVariable> ");
    }
  }
  /**
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:349
   */
  public void populateOntology(RepositoryConnection con, ValueFactory f, URI context) {
		try {
			...
			varCount++;
			con.add(id, OWL.INDIVIDUAL ,f.createURI(sfcBaseURI+"#StringVariable"),context);
   ...
   */
  public _StringVariable(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _StringVariable(List<Attribute> p0, List<Element> p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_StringVariable");
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:910
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getconstant_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:926
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _exp getexp() {
    if(getexp_computed) {
...
if(true) getexp_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:942
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getheight_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:958
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getinitialValue_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:974
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getname_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:990
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getupdated_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1006
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getvalue_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1022
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getwidth_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1038
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _x getx() {
    if(getx_computed) {
...
if(true) getx_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1054
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _y gety() {
    if(gety_computed) {
