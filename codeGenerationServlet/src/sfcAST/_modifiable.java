 ...
 */
public class _modifiable extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _modifiable clone() throws CloneNotSupportedException {
    _modifiable node = (_modifiable)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _modifiable copy() {
      try {
        _modifiable node = (_modifiable)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _modifiable fullCopy() {
    _modifiable res = (_modifiable)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1433
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" modifiable=");
   ...
   */
  public _modifiable(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _modifiable(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_modifiable");
