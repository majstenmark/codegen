 ...
 */
public class _scanCycle extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _scanCycle clone() throws CloneNotSupportedException {
    _scanCycle node = (_scanCycle)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _scanCycle copy() {
      try {
        _scanCycle node = (_scanCycle)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _scanCycle fullCopy() {
    _scanCycle res = (_scanCycle)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1517
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" scanCycle=");
   ...
   */
  public _scanCycle(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _scanCycle(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_scanCycle");
