...
/**
 * @ast node
 * @declaredat sfc.ast:43
 */
public class _horizontalScrollBar extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _horizontalScrollBar clone() throws CloneNotSupportedException {
    _horizontalScrollBar node = (_horizontalScrollBar)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _horizontalScrollBar copy() {
      try {
        _horizontalScrollBar node = (_horizontalScrollBar)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _horizontalScrollBar fullCopy() {
    _horizontalScrollBar res = (_horizontalScrollBar)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1512
   */
   ...
   */
  public _horizontalScrollBar(int i) {
    super(i);
  }
  /**
   * @ast method 
   ...
   */
  public _horizontalScrollBar(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _horizontalScrollBar(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_horizontalScrollBar");
