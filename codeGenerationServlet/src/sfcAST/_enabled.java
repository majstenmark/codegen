 ...
 */
public class _enabled extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _enabled clone() throws CloneNotSupportedException {
    _enabled node = (_enabled)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _enabled copy() {
      try {
        _enabled node = (_enabled)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _enabled fullCopy() {
    _enabled res = (_enabled)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1480
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" enabled=");
   ...
   */
  public _enabled(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_enabled");
