 ...
 */
public class _ownerClass extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _ownerClass clone() throws CloneNotSupportedException {
    _ownerClass node = (_ownerClass)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _ownerClass copy() {
      try {
        _ownerClass node = (_ownerClass)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _ownerClass fullCopy() {
    _ownerClass res = (_ownerClass)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1532
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" ownerClass=");
   ...
   */
  public _ownerClass(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _ownerClass(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_ownerClass");
