 ...
 */
public class _threadSpeed extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _threadSpeed clone() throws CloneNotSupportedException {
    _threadSpeed node = (_threadSpeed)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _threadSpeed copy() {
      try {
        _threadSpeed node = (_threadSpeed)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _threadSpeed fullCopy() {
    _threadSpeed res = (_threadSpeed)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1470
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" threadSpeed=");
   ...
   */
  public _threadSpeed(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _threadSpeed(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_threadSpeed");
