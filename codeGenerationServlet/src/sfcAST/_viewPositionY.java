 ...
 */
public class _viewPositionY extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _viewPositionY clone() throws CloneNotSupportedException {
    _viewPositionY node = (_viewPositionY)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _viewPositionY copy() {
      try {
        _viewPositionY node = (_viewPositionY)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _viewPositionY fullCopy() {
    _viewPositionY res = (_viewPositionY)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1401
   */
   ...
   */
  public _viewPositionY(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _viewPositionY(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_viewPositionY");
