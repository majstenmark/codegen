...
/**
 * @ast node
 * @declaredat sfc.ast:52
 */
public class _color extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _color clone() throws CloneNotSupportedException {
    _color node = (_color)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _color fullCopy() {
    _color res = (_color)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1569
   */
   ...
   */
  public _color(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
