...
/**
 * @ast node
 * @declaredat sfc.ast:49
 */
public class _fileName extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _fileName clone() throws CloneNotSupportedException {
    _fileName node = (_fileName)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _fileName copy() {
      try {
        _fileName node = (_fileName)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _fileName fullCopy() {
    _fileName res = (_fileName)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1542
   */
   ...
   */
  public _fileName(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_fileName");
