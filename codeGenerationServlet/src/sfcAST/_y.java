...
/**
 * @ast node
 * @declaredat sfc.ast:71
 */
public class _y extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _y clone() throws CloneNotSupportedException {
    _y node = (_y)super.clone();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1748
   */
