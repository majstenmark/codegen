 ...
 */
public class __DefaultElement__ extends ComplexElement implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public __DefaultElement__ clone() throws CloneNotSupportedException {
    __DefaultElement__ node = (__DefaultElement__)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public __DefaultElement__ copy() {
      try {
        __DefaultElement__ node = (__DefaultElement__)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public __DefaultElement__ fullCopy() {
    __DefaultElement__ res = (__DefaultElement__)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1374
   */
  public void prettyPrint(String ind, PrintStream pStream) {
    pStream.print(ind+"<"+getTAG()+" ");
   ...
   */
  public __DefaultElement__(int i) {
    super(i);
  }
  /**
   * @ast method 
   ...
   */
  public __DefaultElement__(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public __DefaultElement__(List<Attribute> p0, List<Element> p1, String p2) {
    setChild(p0, 0);
    setChild(p1, 1);
    setTAG(p2);
  }
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "__DefaultElement__"+ "\"" + getTAG() + "\"");
  ...
  /**   * @apilevel internal   */  protected String tokenString_TAG;
  /**
   * Getter for lexeme TAG
   * @apilevel high-level
   * @ast method 
   * @declaredat sfc.ast:13
   */
