 ...
 */
public class _width extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _width clone() throws CloneNotSupportedException {
    _width node = (_width)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _width fullCopy() {
    _width res = (_width)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1396
   */
   ...
   */
  public _width(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
