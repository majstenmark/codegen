 ...
 */
public class _name extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _name clone() throws CloneNotSupportedException {
    _name node = (_name)super.clone();
    node.name_visited = -1;
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _name fullCopy() {
    _name res = (_name)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1490
   */
   ...
   */
  public _name(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   * @attribute syn
   * @aspect SFCtoRDF
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:629
   */
  @SuppressWarnings({"unchecked", "cast"})
  public String name() {
   ...
   * @apilevel internal
   */
  private String name_compute() {  return value();  }
  /**
   * @apilevel internal
   */
