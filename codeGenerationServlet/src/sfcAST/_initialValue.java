...
/**
 * @ast node
 * @declaredat sfc.ast:53
 */
public class _initialValue extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _initialValue clone() throws CloneNotSupportedException {
    _initialValue node = (_initialValue)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _initialValue copy() {
      try {
        _initialValue node = (_initialValue)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _initialValue fullCopy() {
    _initialValue res = (_initialValue)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1574
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" initialValue=");
   ...
   */
  public _initialValue(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _initialValue(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_initialValue");
   ...
   * @attribute syn
   * @aspect SFCtoRDF
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:673
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @apilevel internal
   */
  private String initialValue_compute() {  return value();  }
  /**
   * @apilevel internal
   */
