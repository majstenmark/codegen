...
/**
 * @ast node
 * @declaredat sfc.ast:48
 */
public class _dpwsInterface extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _dpwsInterface clone() throws CloneNotSupportedException {
    _dpwsInterface node = (_dpwsInterface)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _dpwsInterface copy() {
      try {
        _dpwsInterface node = (_dpwsInterface)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _dpwsInterface fullCopy() {
    _dpwsInterface res = (_dpwsInterface)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1537
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" dpwsInterface=");
   ...
   */
  public _dpwsInterface(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _dpwsInterface(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_dpwsInterface");
