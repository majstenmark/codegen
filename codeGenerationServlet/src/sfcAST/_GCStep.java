...
/**
 * @ast node
 * @declaredat sfc.ast:76
 */
public class _GCStep extends ComplexElement implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _GCStep clone() throws CloneNotSupportedException {
    _GCStep node = (_GCStep)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _GCStep fullCopy() {
    _GCStep res = (_GCStep)copy();
   ...
   * @ast method 
   * @aspect GenerateXML
   * @declaredat /Users/maj/Documents/workspace/sfctest/GenerateXML.jrag:138
   */
  public void generateXML(PrintStream out,int ind,Value val,RepositoryConnection con) {
		...
		out.print(ind(ind)+"<GCStep id=\""+id+"\" fileName=\"\" height=\"70\"  name="+name+" useIcon=\"0\" width=\"60\" x=\"70\" y=\"25\"");
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1797
   */
  public void prettyPrint(String ind, PrintStream pStream) {
    pStream.print(ind+"<GCStep ");
    ...
    if (getNumElement() == 0) {
       ...
       pStream.println(ind+"</GCStep> ");
    }
  }
  /**
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:147
   */
  public void populateOntology(RepositoryConnection con, ValueFactory f, URI context) {
		try {
			...
			con.add(stepURI,OWL.INDIVIDUAL, f.createURI(sfcBaseURI+"#Step"), context);
   ...
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:463
   */
   ...
   * @ast method 
   * @aspect NavigateSFC
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:888
   */
   ...
   */
  public _GCStep(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _GCStep(List<Attribute> p0, List<Element> p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_GCStep");
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:606
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getactionBlockVisible_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:614
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getactionText_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:622
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getfileName_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:630
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getheight_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:638
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _id getid() {
    if(getid_computed) {
...
if(true) getid_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:646
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getname_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:654
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getuseIcon_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:662
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getwidth_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:670
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _x getx() {
    if(getx_computed) {
...
if(true) getx_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:678
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _y gety() {
    if(gety_computed) {
...
if(true) gety_computed = true;
   ...
   * @attribute syn
   * @aspect NavigateSFC
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:759
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect Collect
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:944
   */
  @SuppressWarnings({"unchecked", "cast"})
