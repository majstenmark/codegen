...
/**
 * @ast node
 * @declaredat sfc.ast:35
 */
public class _verticalScrollBar extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _verticalScrollBar clone() throws CloneNotSupportedException {
    _verticalScrollBar node = (_verticalScrollBar)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _verticalScrollBar copy() {
      try {
        _verticalScrollBar node = (_verticalScrollBar)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _verticalScrollBar fullCopy() {
    _verticalScrollBar res = (_verticalScrollBar)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1460
   */
   ...
   */
  public _verticalScrollBar(int i) {
    super(i);
  }
  /**
   * @ast method 
   ...
   */
  public _verticalScrollBar(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _verticalScrollBar(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_verticalScrollBar");
