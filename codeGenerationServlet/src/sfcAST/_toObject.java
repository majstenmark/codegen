 ...
 */
public class _toObject extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _toObject clone() throws CloneNotSupportedException {
    _toObject node = (_toObject)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _toObject copy() {
      try {
        _toObject node = (_toObject)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _toObject fullCopy() {
    _toObject res = (_toObject)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1594
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" toObject=");
   ...
   */
  public _toObject(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_toObject");
