...
/**
 * @ast node
 * @declaredat sfc.ast:51
 */
public class _socketHost extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _socketHost clone() throws CloneNotSupportedException {
    _socketHost node = (_socketHost)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _socketHost copy() {
      try {
        _socketHost node = (_socketHost)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _socketHost fullCopy() {
    _socketHost res = (_socketHost)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1564
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" socketHost=");
   ...
   */
  public _socketHost(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _socketHost(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_socketHost");
