 ...
 */
public class _saveVersion extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _saveVersion clone() throws CloneNotSupportedException {
    _saveVersion node = (_saveVersion)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _saveVersion copy() {
      try {
        _saveVersion node = (_saveVersion)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _saveVersion fullCopy() {
    _saveVersion res = (_saveVersion)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1522
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" saveVersion=");
   ...
   */
  public _saveVersion(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _saveVersion(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_saveVersion");
