...
/**
 * @ast node
 * @declaredat sfc.ast:54
 */
public class _constant extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _constant clone() throws CloneNotSupportedException {
    _constant node = (_constant)super.clone();
  ...
  public _constant copy() {
      try {
        _constant node = (_constant)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _constant fullCopy() {
    _constant res = (_constant)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1579
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" constant=");
   ...
   */
  public _constant(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_constant");
   ...
   * @attribute syn
   * @aspect SFCtoRDF
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:651
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @apilevel internal
   */
  private String constant_compute() {  return value();  }
  /**
   * @apilevel internal
   */
