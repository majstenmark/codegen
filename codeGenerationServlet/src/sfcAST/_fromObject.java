...
/**
 * @ast node
 * @declaredat sfc.ast:81
 */
public class _fromObject extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _fromObject clone() throws CloneNotSupportedException {
    _fromObject node = (_fromObject)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _fromObject copy() {
      try {
        _fromObject node = (_fromObject)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _fromObject fullCopy() {
    _fromObject res = (_fromObject)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1858
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" fromObject=");
   ...
   */
  public _fromObject(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _fromObject(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_fromObject");
