...
/**
 * @ast node
 * @declaredat sfc.ast:65
 */
public class _ExitStep extends ComplexElement implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _ExitStep clone() throws CloneNotSupportedException {
    _ExitStep node = (_ExitStep)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _ExitStep copy() {
      try {
        _ExitStep node = (_ExitStep)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _ExitStep fullCopy() {
    _ExitStep res = (_ExitStep)copy();
   ...
   * @ast method 
   * @aspect GenerateXML
   * @declaredat /Users/maj/Documents/workspace/sfctest/GenerateXML.jrag:229
   */
  public void generateXML(PrintStream out,int ind,Value val,RepositoryConnection con) {
		String id = (val.toString().split("#"))[1];
		out.print(ind(ind)+"<ExitStep id=\""+id+"\" fileName=\"\" height=\"70\"  name=\"\" useIcon=\"0\" width=\"60\" x=\"70\" y=\"25\"");
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1682
   */
  public void prettyPrint(String ind, PrintStream pStream) {
    pStream.print(ind+"<ExitStep ");
    ...
    if (getNumElement() == 0) {
       ...
       pStream.println(ind+"</ExitStep> ");
    }
  }
  /**
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:242
   */
  public void populateOntology(RepositoryConnection con, ValueFactory f, URI context) {
		try {
			...
			con.add(stepURI,OWL.INDIVIDUAL, f.createURI(sfcBaseURI+"#ExitStep"), context);
			con.add(stepURI, f.createURI(baseURI+"#name"), stepName, context);
			enclMacroStep().addExitNode(stepURI,con,f,context);
			// System.out.println(step.uri());
			...
			for (String param : params("param")) {
				...
				// URI paramClassURI = f.createURI(sfcBaseURI+"#ShieldCanInsertionParameter");
   ...
   */
  public _ExitStep(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _ExitStep(List<Attribute> p0, List<Element> p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_ExitStep");
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:526
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getactionBlockVisible_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:534
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getactionText_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:542
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getfileName_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:550
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getheight_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:558
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _id getid() {
    if(getid_computed) {
...
if(true) getid_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:566
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getname_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:574
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getuseIcon_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:582
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getwidth_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:590
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _x getx() {
    if(getx_computed) {
...
if(true) getx_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:598
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _y gety() {
    if(gety_computed) {
...
if(true) gety_computed = true;
   ...
   * @attribute syn
   * @aspect NavigateSFC
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:794
   */
  @SuppressWarnings({"unchecked", "cast"})
