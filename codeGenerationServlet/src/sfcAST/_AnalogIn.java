 ...
 */
public class _AnalogIn extends ComplexElement implements Cloneable {
  /**
   * @apilevel low-level
   */
  public void flushCache() {
    ...
    getcyclic_visited = -1;
    getcyclic_computed = false;
    getcyclic_value = null;
    getheight_visited = -1;
  ...
  public _AnalogIn clone() throws CloneNotSupportedException {
    _AnalogIn node = (_AnalogIn)super.clone();
    node.getchannel_visited = -1;
    node.getchannel_computed = false;
    node.getchannel_value = null;
    node.getcyclic_visited = -1;
    node.getcyclic_computed = false;
    node.getcyclic_value = null;
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _AnalogIn copy() {
      try {
        _AnalogIn node = (_AnalogIn)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _AnalogIn fullCopy() {
    _AnalogIn res = (_AnalogIn)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1547
   */
  public void prettyPrint(String ind, PrintStream pStream) {
    pStream.print(ind+"<AnalogIn ");
    ...
    if (getNumElement() == 0) {
       ...
       pStream.println(ind+"</AnalogIn> ");
    }
  }
  /**
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:366
   */
  public void populateOntology(RepositoryConnection con, ValueFactory f, URI context) {
		try {
			...
			con.add(id, OWL.INDIVIDUAL ,f.createURI(sfcBaseURI+"#AnalogIn"),context);
   ...
   */
  public _AnalogIn(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _AnalogIn(List<Attribute> p0, List<Element> p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_AnalogIn");
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1263
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getchannel_computed = true;
   ...
   * @apilevel internal
   */
  protected int getcyclic_visited = -1;
  /**
   * @apilevel internal
   */
  protected boolean getcyclic_computed = false;
  /**
   * @apilevel internal
   */
  protected _cyclic getcyclic_value;
  /**
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1271
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _cyclic getcyclic() {
    if(getcyclic_computed) {
      return getcyclic_value;
    }
      ASTNode$State state = state();
    if(getcyclic_visited == state().boundariesCrossed)
      throw new RuntimeException("Circular definition of attr: getcyclic in class: ");
    getcyclic_visited = state().boundariesCrossed;
  int num = state.boundariesCrossed;
  boolean isFinal = this.is$Final();
    getcyclic_value = getcyclic_compute();
    getcyclic_value.setParent(this);
    getcyclic_value.is$Final = true;
if(true) getcyclic_computed = true;
    getcyclic_visited = -1;
    return getcyclic_value;
  }
  /**
   * @apilevel internal
   */
  private _cyclic getcyclic_compute() {
        for (Attribute a : getAttributes()) {
            if (a instanceof _cyclic) {
                return (_cyclic) a;
            }
        }
        return null;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1279
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getheight_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1287
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getname_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1295
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getvalue_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1303
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getwidth_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1311
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _x getx() {
    if(getx_computed) {
...
if(true) getx_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1319
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _y gety() {
    if(gety_computed) {
