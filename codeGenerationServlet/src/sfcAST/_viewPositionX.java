 ...
 */
public class _viewPositionX extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _viewPositionX clone() throws CloneNotSupportedException {
    _viewPositionX node = (_viewPositionX)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _viewPositionX copy() {
      try {
        _viewPositionX node = (_viewPositionX)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _viewPositionX fullCopy() {
    _viewPositionX res = (_viewPositionX)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1406
   */
   ...
   */
  public _viewPositionX(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _viewPositionX(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_viewPositionX");
