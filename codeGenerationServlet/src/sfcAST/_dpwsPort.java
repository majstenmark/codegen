...
/**
 * @ast node
 * @declaredat sfc.ast:61
 */
public class _dpwsPort extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _dpwsPort clone() throws CloneNotSupportedException {
    _dpwsPort node = (_dpwsPort)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _dpwsPort copy() {
      try {
        _dpwsPort node = (_dpwsPort)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _dpwsPort fullCopy() {
    _dpwsPort res = (_dpwsPort)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1638
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" dpwsPort=");
   ...
   */
  public _dpwsPort(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_dpwsPort");
