...
/**
 * @ast node
 * @declaredat sfc.ast:66
 */
public class _conditionVisible extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _conditionVisible clone() throws CloneNotSupportedException {
    _conditionVisible node = (_conditionVisible)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _conditionVisible copy() {
      try {
        _conditionVisible node = (_conditionVisible)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _conditionVisible fullCopy() {
    _conditionVisible res = (_conditionVisible)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1699
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" conditionVisible=");
   ...
   */
  public _conditionVisible(int i) {
    super(i);
  }
  /**
   * @ast method 
   ...
   */
  public _conditionVisible(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _conditionVisible(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_conditionVisible");
