 ...
 */
public class _scale extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _scale clone() throws CloneNotSupportedException {
    _scale node = (_scale)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _scale fullCopy() {
    _scale res = (_scale)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1643
   */
   ...
   */
  public _scale(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
