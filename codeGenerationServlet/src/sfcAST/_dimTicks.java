...
/**
 * @ast node
 * @declaredat sfc.ast:79
 */
public class _dimTicks extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _dimTicks clone() throws CloneNotSupportedException {
    _dimTicks node = (_dimTicks)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _dimTicks copy() {
      try {
        _dimTicks node = (_dimTicks)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _dimTicks fullCopy() {
    _dimTicks res = (_dimTicks)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1836
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" dimTicks=");
   ...
   */
  public _dimTicks(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_dimTicks");
