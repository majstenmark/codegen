 ...
 */
public class _useIcon extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _useIcon clone() throws CloneNotSupportedException {
    _useIcon node = (_useIcon)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _useIcon copy() {
      try {
        _useIcon node = (_useIcon)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _useIcon fullCopy() {
    _useIcon res = (_useIcon)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1465
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" useIcon=");
   ...
   */
  public _useIcon(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_useIcon");
