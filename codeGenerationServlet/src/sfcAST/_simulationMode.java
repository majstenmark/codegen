...
/**
 * @ast node
 * @declaredat sfc.ast:60
 */
public class _simulationMode extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _simulationMode clone() throws CloneNotSupportedException {
    _simulationMode node = (_simulationMode)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _simulationMode copy() {
      try {
        _simulationMode node = (_simulationMode)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _simulationMode fullCopy() {
    _simulationMode res = (_simulationMode)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1633
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" simulationMode=");
   ...
   */
  public _simulationMode(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _simulationMode(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_simulationMode");
