 ...
 */
public class _GCTransition extends ComplexElement implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _GCTransition clone() throws CloneNotSupportedException {
    _GCTransition node = (_GCTransition)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _GCTransition copy() {
      try {
        _GCTransition node = (_GCTransition)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _GCTransition fullCopy() {
    _GCTransition res = (_GCTransition)copy();
   ...
   * @ast method 
   * @aspect GenerateXML
   * @declaredat /Users/maj/Documents/workspace/sfctest/GenerateXML.jrag:431
   */
  public void generateXML(PrintStream out,int ind,Value val,RepositoryConnection con) {
		String id = (val.toString().split("#"))[1];
		out.print(ind(ind)+"<GCTransition id=\""+id+"\" conditionVisible=\"1\" height=\"25\" width=\"30\" x=\"85\" y=\"110\"");
		...
		try {
			...
			out.println(">");
			out.println(ind(ind)+"</GCTransition>");		
		//	System.out.println("Query: "+"{sfc:"+id+" sfc:hasNextStep ?step}");
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1438
   */
  public void prettyPrint(String ind, PrintStream pStream) {
    pStream.print(ind+"<GCTransition ");
    ...
    if (getNumElement() == 0) {
       ...
       pStream.println(ind+"</GCTransition> ");
    }
  }
  /**
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:281
   */
  public void populateOntology(RepositoryConnection con, ValueFactory f, URI context) {
		try {
			con.add(f.createURI(baseURI+"#"+id()), OWL.INDIVIDUAL ,f.createURI(baseURI+"#Transition"), 
					context);
			addActionText(f.createURI(baseURI+"#"+id()),con,f,context);
		} catch (OpenRDFException e) {
			// handle exception
			e.printStackTrace(System.out);
		}
   ...
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:493
   */
   ...
   */
  public _GCTransition(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _GCTransition(List<Attribute> p0, List<Element> p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_GCTransition");
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:686
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getCGURI_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:694
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getactionText_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:702
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getconditionVisible_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:710
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getheight_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:718
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _id getid() {
    if(getid_computed) {
...
if(true) getid_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:726
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getwidth_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:734
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _x getx() {
    if(getx_computed) {
...
if(true) getx_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:742
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _y gety() {
    if(gety_computed) {
...
if(true) gety_computed = true;
   ...
   * @attribute syn
   * @aspect NavigateSFC
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:766
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect Collect
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:957
   */
  @SuppressWarnings({"unchecked", "cast"})
