...
/**
 * @ast node
 * @declaredat sfc.ast:78
 */
public class _ParallelJoin extends ComplexElement implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _ParallelJoin clone() throws CloneNotSupportedException {
    _ParallelJoin node = (_ParallelJoin)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _ParallelJoin copy() {
      try {
        _ParallelJoin node = (_ParallelJoin)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _ParallelJoin fullCopy() {
    _ParallelJoin res = (_ParallelJoin)copy();
   ...
   * @ast method 
   * @aspect GenerateXML
   * @declaredat /Users/maj/Documents/workspace/sfctest/GenerateXML.jrag:321
   */
  public void generateXML(PrintStream out,int ind,Value val,RepositoryConnection con) {
		String id = (val.toString().split("#"))[1];
		out.println(ind(ind)+"<ParallelJoin id=\""+id+"\" height=\"14\"  width=\"1063\" x=\"143\" y=\"295\"/>");
		...
		try {
			...
			// }
			// out.println(">");
			// out.println(ind(ind)+"</ParallelSplit>");		
			TupleQueryResult result = queryRepo(con,"{sfc:"+id+" sfc:hasNextTransition ?trans}");
			while (result.hasNext()) {
				BindingSet bSet = result.next();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1819
   */
  public void prettyPrint(String ind, PrintStream pStream) {
    pStream.print(ind+"<ParallelJoin ");
    ...
    if (getNumElement() == 0) {
       ...
       pStream.println(ind+"</ParallelJoin> ");
    }
  }
  /**
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:323
   */
  public void populateOntology(RepositoryConnection con, ValueFactory f, URI context) {
		try {
			con.add(f.createURI(sfcBaseURI+"#"+id()), OWL.INDIVIDUAL ,f.createURI(sfcBaseURI+"#ParallelJoin"), 
					context);
		} catch (OpenRDFException e) {
			// handle exception
			e.printStackTrace(System.out);
   ...
   * @ast method 
   * @aspect PopulateOntology
   * @declaredat /Users/maj/Documents/workspace/sfctest/SFCtoRDF.jrag:513
   */
   ...
   */
  public _ParallelJoin(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _ParallelJoin(List<Attribute> p0, List<Element> p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_ParallelJoin");
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:862
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getheight_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:870
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _id getid() {
    if(getid_computed) {
...
if(true) getid_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:878
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(true) getwidth_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:886
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _x getx() {
    if(getx_computed) {
...
if(true) getx_computed = true;
   ...
   * @attribute syn
   * @aspect NTA
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:894
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _y gety() {
    if(gety_computed) {
