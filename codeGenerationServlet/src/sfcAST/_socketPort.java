...
/**
 * @ast node
 * @declaredat sfc.ast:38
 */
public class _socketPort extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _socketPort clone() throws CloneNotSupportedException {
    _socketPort node = (_socketPort)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _socketPort copy() {
      try {
        _socketPort node = (_socketPort)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _socketPort fullCopy() {
    _socketPort res = (_socketPort)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1475
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" socketPort=");
   ...
   */
  public _socketPort(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
   ...
   */
  public _socketPort(AttrValue p0) {
    setChild(p0, 0);
  }
  /**
   * @ast method 
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_socketPort");
