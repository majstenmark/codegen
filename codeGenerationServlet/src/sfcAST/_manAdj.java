...
/**
 * @ast node
 * @declaredat sfc.ast:55
 */
public class _manAdj extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _manAdj clone() throws CloneNotSupportedException {
    _manAdj node = (_manAdj)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _manAdj fullCopy() {
    _manAdj res = (_manAdj)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1584
   */
   ...
   */
  public _manAdj(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_manAdj");
