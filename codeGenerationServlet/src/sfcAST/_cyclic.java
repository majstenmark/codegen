...
/**
 * @ast node
 * @declaredat sfc.ast:77
 */
public class _cyclic extends Attribute implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public _cyclic clone() throws CloneNotSupportedException {
    _cyclic node = (_cyclic)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public _cyclic fullCopy() {
    _cyclic res = (_cyclic)copy();
   ...
   * @declaredat /Users/maj/Documents/workspace/sfctest/GeneratedAspects.jrag:1814
   */
  public void prettyPrint(String indent, PrintStream pStream) {
    pStream.print(" cyclic=");
   ...
   */
  public _cyclic(XmlParser p, int i) {
    this(i);
    parser = p;
  }
  /**
  ...
  public void dumpTree(String indent, java.io.PrintStream pStream) {
    pStream.println(indent + "_cyclic");
