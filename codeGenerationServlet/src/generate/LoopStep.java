...
public class LoopStep extends ProgramElement {
	
	public ArrayList<ProgramElement> nestedStatements = new ArrayList<ProgramElement>();
	...
	public void addProgramElement(ProgramElement e){
